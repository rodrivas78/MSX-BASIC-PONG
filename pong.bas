10 'my PONG -  MSX-BASIC - by Rodrigo Rivas (rodrrivas)
20 SCREEN 2,2,0
30 OPEN"GRP:"AS#1
...
990 PSET(87,88),1:COLOR1:PRINT#1,"ллллллллл"
1000 PSET(87,95),1:COLOR1:PRINT#1,"лллллллл"
1010 PSET(80,90),1:COLOR15:PRINT#1,"PLAYER 1 WINS!!!":FOR J=0 TO 1000:NEXT:J=0
1020 FOR H=1 TO 14
1030 PSET(80,90),1:COLOR H:PRINT#1,"PLAYER 1 WINS!!!"
1040 NEXT
1050 GOTO 1120
1060 PSET(87,88),1:COLOR1:PRINT#1,"ллллллллл"
1070 PSET(87,95),1:COLOR1:PRINT#1,"лллллллл"
